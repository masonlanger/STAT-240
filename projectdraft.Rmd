...
-   $r=-0.8997$ suggests that the data points are tightly clustered around a negative slope, and that there is a strong negative linear association between Adjusted Efficiency Margin and Seeding

**Regression Hypothesis Testing with Adjusted Efficiency Margin and Seeds**<br>
...
ggplot(ncaa_full, aes(x = AdjEM, y = seed_season, color = seeding)) +
  geom_point() +
  geom_abline(slope = -0.466, intercept = 15.756)
```
